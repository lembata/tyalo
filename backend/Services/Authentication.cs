	...
	RefreshTokenGenerator refreshTokenGenerator)
{
	...
	public async Task<bool> Invalidate(string refreshToken)
	{
		if (string.IsNullOrWhiteSpace(refreshToken))
		{
			return false;
		...
		var affectedRows = await db.RefreshTokens.ExecuteUpdateAsync(setters => setters.SetProperty(t => t.Revoked, true));
